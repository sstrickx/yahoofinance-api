...
public class FxSymbols {
    ...
    public static final String USDHKD = "USDTRY=X";
    ...
    public static final String USDHKD = "GBPTRY=X";
    ...
    public static final String USDHKD = "EURTRY=X";
    ...
    public static final String JPYHKD = "JPYTRY=X";
